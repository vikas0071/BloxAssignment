...
class ApiCaller {
  final int maxRequestsPerMinute = 20; // Increased limit to 20 calls per minute
  final int penaltyDuration =
      60; // 60 seconds (1 minute) penalty for crossing the limit
  int tokens = 0;
...
void main() async {
  ...
  for (int i = 1; i <= 30; i++) {
    // Increase the number of API calls to 30
